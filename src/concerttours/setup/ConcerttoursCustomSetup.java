...
public class ConcerttoursCustomSetup
{
	...
	/*
	 * @SystemSetup(type = SystemSetup.Type.PROJECT) public boolean addMyProjectData() {
	 * LOG.info("Starting custom project data loading for the Concerttours extension");
	 * impexImport("/impex/concerttours-bands.impex"); impexImport("/impex/concerttours-yBandTour.impex");
	 * LOG.info("Custom project data loading for the Concerttours extension completed."); return true; }
	 */
	...
	public boolean addMyProjectData()
	{
		...
		impexImport("/impex/concerttours-students.impex");
